# Generated by Powerlevel10k configuration wizard on 2021-11-10 at 14:45 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%254F─┤'
...
if [[ "$(cat /etc/*-release | grep DISTRIB_ID | sed 's/DISTRIB_ID=//g')" == "Ubuntu" ]]; then
  ...
  typeset -g POWERLEVEL9K_LOCK_ICON='%001F'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=208
  ...
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=213
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=3
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING= 
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=16
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=32
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=208
