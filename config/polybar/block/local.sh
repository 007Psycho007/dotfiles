...
elif [[ $(uname -n) == "adconova-pc" ]];then 
   export MAIN_LEFT="menu end-left-i3 i3 end-right-i3 keymap end-right-i3 end-right mode"
   export MAIN_CENTER="title"
   export MAIN_RIGHT="end-left cpu sep-1 memory sep-1 battery sep-1 disk_home sep-1 disk_root sep-1 date"
...
elif [[ $(uname -n) == "arch-steamdeck" ]];then 
   export MAIN_LEFT="menu end-left-i3 i3 end-right-i3 keymap end-right-i3 end-right mode"
   export MAIN_CENTER="title"
